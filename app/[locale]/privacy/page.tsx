...
export default async function PrivacyPage({
  ...
  const sections = [
    ...
    },
    {
      ...
      body: t(
        "We use service providers to receive form submissions, manage customer follow-up, host the website, and understand page performance. These may include GoHighLevel, Web3Forms, Vercel, Meta, Google Analytics, and Microsoft Clarity. They process information under their own terms and privacy notices. Analytics tools receive browser, device, page, and campaign information through cookies or similar technology. When you submit a quote request, we may also send Meta a hashed, unreadable version of the contact details you submitted, such as your name, email, phone number, and ZIP code, so Meta can tell us whether our own ads led to that request. Hashing means Meta receives a scrambled code in place of the readable value. We do this to measure our own advertising and for no other purpose. Your text messaging opt-in and your consent record are never shared with anyone.",
        "Usamos proveedores para recibir formularios, manejar el seguimiento al cliente, alojar el sitio y entender el rendimiento de las páginas. Estos pueden incluir GoHighLevel, Web3Forms, Vercel, Meta, Google Analytics y Microsoft Clarity. Ellos procesan información bajo sus propios términos y avisos de privacidad. Las herramientas de analítica reciben información del navegador, dispositivo, página y campaña mediante cookies o tecnología similar. Cuando usted envía una solicitud de cotización, también podemos enviar a Meta una versión codificada e ilegible de los datos de contacto que usted escribió, como su nombre, correo, teléfono y código postal, para que Meta nos diga si nuestros propios anuncios llevaron a esa solicitud. La codificación significa que Meta recibe un código en lugar del valor legible. Lo hacemos para medir nuestra propia publicidad y para ningún otro fin. Su suscripción a mensajes de texto y su registro de consentimiento no se comparten con nadie.",
      ),
    },
    {
