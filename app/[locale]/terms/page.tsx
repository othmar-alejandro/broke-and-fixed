      ...
      <article className="mx-auto max-w-3xl rounded-md border border-[#d9e0ea] bg-white p-6 shadow-[0_18px_55px_rgba(15,31,53,0.08)] sm:p-10">
        ...
        <section className="mt-9 rounded-md border border-[#d9e0ea] bg-[#f8f9fc] p-6">
          ...
          <p className="mt-3 text-[16.5px] leading-7 text-[#33465f]">
            {t(
              "Broke & Fixed Home Solutions, a registered DBA of Loadr Solutions LLC, sends text messages to people who ask about a project through this website or by phone. Messages cover estimate follow-ups, appointment confirmations, and updates about the project you asked about. Message frequency varies. Message and data rates may apply. Consent to receive text messages is not a condition of any purchase. Carriers are not liable for delayed or undelivered messages.",
              "Broke & Fixed Home Solutions, nombre comercial registrado (DBA) de Loadr Solutions LLC, envía mensajes de texto a personas que preguntan por un proyecto mediante este sitio o por teléfono. Los mensajes cubren seguimientos de estimados, confirmaciones de cita y actualizaciones sobre el proyecto que usted consultó. La frecuencia de mensajes varía. Pueden aplicar cargos de mensajes y datos. El consentimiento para recibir mensajes de texto no es una condición de compra. Las operadoras no son responsables por mensajes demorados o no entregados.",
            )}
          </p>
          <p className="mt-3 text-[16.5px] leading-7 text-[#33465f]">
            <strong>
