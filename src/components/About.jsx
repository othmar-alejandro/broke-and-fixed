...
export default function About() {
  ...
  const stats = [
    ...
    t('about.stats.insured', { returnObjects: true }),
    t('about.stats.subs', { returnObjects: true }),
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-16 lg:gap-24">
          <div>
            ...
            <ScrollReveal delay={0.05}>
              <h2 className="font-display text-4xl md:text-6xl font-bold tracking-tighter leading-[0.95] text-white mb-8">
                {t('about.headline1')}
                <br />
                <span className="text-sage-muted">{t('about.headline2')}</span>
              </h2>
            </ScrollReveal>
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 w-full">
              {stats.map((stat, i) => (
                <ScrollReveal key={i} delay={0.15 + i * 0.05} className="w-full h-full">
